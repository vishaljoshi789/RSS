...
const requirements = [
  {
    ...
    text: "स्थाई स्वामित्व के लिए भूमि / भवन",
    color: "bg-blue-500",
  },
  {
    icon: <Book className="w-5 h-5" />,
    text: "निर्धन बच्चों की पुस्तक एवं लेखन आदि की सामग्री",
    color: "bg-purple-500",
  },
  {
    icon: <Shirt className="w-5 h-5" />,
    text: "विद्यार्थियों के लिए वस्त्र, भोजन सामग्री, खेलकूद सामग्री",
    color: "bg-green-500",
  },
  {
    icon: <Wheat className="w-5 h-5" />,
    text: "गौशालाओं में गौमाता की सुरक्षा एवं जीवन यापन हेतु चारा",
    color: "bg-yellow-500",
  },
  {
    icon: <Building2 className="w-5 h-5" />,
    text: "गुरुकुल निर्माण हेतु सामग्री एवं अन्य मूलभूत सुविधा",
    color: "bg-orange-500",
  },
  {
    icon: <Ambulance className="w-5 h-5" />,
    text: "वंचितों के लिए निःशुल्क संचालित सेवा हेतु एम्बुलेंस",
    color: "bg-red-500",
  },
  {
    icon: <Shield className="w-5 h-5" />,
    text: "बहन बेटियों की सुरक्षा हेतु संसाधन",
    color: "bg-pink-500",
  },
];
      ...
      <Card className="mb-6 sm:mb-8 shadow-md">
        <CardContent className="p-4 sm:p-6 md:p-8">
          ...
          <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed">
            <p>
              हमारे द्वारा{" "}
              <strong className="text-foreground">निःशुल्क रूप से</strong>{" "}
              सनातनी समाज में धार्मिक मूल्यों की रक्षा, बहन बेटियों की सुरक्षा,
              मठ मंदिरों का संरक्षण, शिक्षा स्वास्थ्य एवं रोजगार की स्थिति
              सुधार, धार्मिक संस्कारों को बचाने हेतु{" "}
              <strong className="text-foreground">(गुरुकुल)</strong> के साथ-साथ
              अन्य प्रकल्पों द्वारा भारतीय संस्कृति को पुनः गौरव प्रदान करने का
              यह भागीरथ प्रयास तभी सफल हो सकता है जब इसमें अधिक से अधिक सामान्य
              और विशिष्टजनों का सहयोग प्राप्त होगा।
            </p>
            <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 bg-orange-50 dark:bg-orange-950/30 rounded-lg border border-orange-200 dark:border-orange-800">
              ...
              <p className="text-foreground font-medium text-xs sm:text-sm md:text-base">
                हम सभी सुधीजनों से व्यक्तिगत अपील करते हैं कि इस अभियान को
                यथासंभव तन, मन और धन से सहयोग कर इस अनुपम प्रयास को पल्लवित और
                पुष्पित होने में भागीदार बनें।
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 bg-orange-50 dark:bg-orange-950/30 rounded-lg p-4 sm:p-6 border border-orange-200 dark:border-orange-800">
            ...
            <p className="text-sm sm:text-base md:text-lg text-orange-700 dark:text-orange-300 font-semibold text-center leading-relaxed py-3 sm:py-4">
              देवतार्थं च यज्ञार्थं ब्राह्मणार्थं गवार्थकम्।
              <br />
      ...
      <Card className="mb-6 sm:mb-8 border shadow-md">
        <CardHeader className="border-b bg-muted/30 p-4 sm:p-6">
          ...
          <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            के संकल्पों की पूर्ति हेतु निम्न आवश्यकताएं हैं:
          </p>
        </CardHeader>
        <CardContent className="p-4 sm:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
            {requirements.map((item, index) => (
              ...
              >
                <div
                  className={`inline-flex p-2 sm:p-3 ${item.color} rounded-lg mb-3 sm:mb-4 group-hover:scale-110 transition-transform`}
                >
          ...
          <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-amber-50 dark:bg-amber-950/30 rounded-lg border border-amber-200 dark:border-amber-800">
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                <p className="text-sm sm:text-base font-bold text-foreground mb-1.5 sm:mb-2">
                  सभी दानदाताओं से आग्रह
                </p>
                <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                  व्यक्तिगत या सामूहिक रूप से अपनी रुचि के अनुसार वस्तु, उपयोगी
                  सामग्री एवं धन संगठन कार्यालय में अथवा बैंक के माध्यम से दे
                  सकते हैं।
                </p>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 mb-6 sm:mb-8">
        <Card className="shadow-md border">
          ...
          <CardContent className="p-4 sm:p-6 space-y-3 sm:space-y-4">
            {[
              ...
              <div key={item.field}>
                <p className="text-[10px] sm:text-xs text-muted-foreground mb-1.5 font-medium">
                  {item.label}
                </p>
                <div className="flex items-center justify-between bg-muted/50 rounded-lg p-2 sm:p-3 border hover:border-primary/50 transition-colors gap-2">
                  <p className="text-xs sm:text-base font-bold text-foreground font-mono truncate">
                    {item.value}
                  </p>
                  <Button
                    variant="ghost"
            ...
            <div className="mt-6 pt-6 border-t">
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 rounded-xl p-4 sm:p-5 border-2 border-green-200 dark:border-green-800">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      <Badge className="bg-green-500 text-white text-xs">80G</Badge>
                      <Badge className="bg-green-500 text-white text-xs">12AA</Badge>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed mb-4">
                  ...
                  <strong className="text-green-600 dark:text-green-400">आयकर से पूर्णतः मुक्त</strong> होगी।
                </p>

                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  <div className="flex items-center gap-2 bg-white dark:bg-gray-900 rounded-lg p-2 sm:p-3 border border-green-200 dark:border-green-800">
                    <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0" />
                    <span className="text-xs sm:text-sm font-medium text-foreground">100% कर मुक्त</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white dark:bg-gray-900 rounded-lg p-2 sm:p-3 border border-green-200 dark:border-green-800">
                    <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0" />
                    <span className="text-xs sm:text-sm font-medium text-foreground">पंजीकृत ट्रस्ट</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="border shadow-md">
          ...
          <CardContent className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            {/* QR Code and Phone Number Section */}
            <div className="bg-purple-50 dark:bg-purple-950/30 rounded-xl border-2 border-purple-200 dark:border-purple-800 overflow-hidden">
              {/* QR Code */}
              <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 flex flex-col items-center justify-center border-b-2 border-purple-200 dark:border-purple-800">
                <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4 font-semibold">
                  QR code
                </p>
                <div className="relative w-40 h-40 sm:w-48 sm:h-48 bg-white rounded-lg p-2">
                  <Image
                    src="/hero/qr-code.jpg"
                    alt="UPI QR Code"
                    fill
              ...
              {/* Phone Number */}
              <div className="p-4 sm:p-6 bg-gradient-to-br from-purple-50 to-white dark:from-purple-950/30 dark:to-gray-900">
                <p className="text-xs sm:text-sm text-muted-foreground mb-3 font-semibold text-center">
                  Phone number
                </p>
                <div className="flex items-center justify-between gap-3 bg-white dark:bg-gray-900 p-3 sm:p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="p-2 bg-purple-500 rounded-lg flex-shrink-0">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                    </div>
                    <p className="text-lg sm:text-xl lg:text-2xl font-black text-foreground font-mono">
                      9690511008
                    </p>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-8 w-8 sm:h-10 sm:w-10 p-0 flex-shrink-0 hover:bg-purple-100 dark:hover:bg-purple-900"
            ...
            {/* Details Section */}
            <div className="bg-muted/30 rounded-xl border-2 border-border p-4 sm:p-6">
              <p className="text-xs sm:text-sm font-bold text-foreground mb-4">
                Details
              </p>
              ...
              <div className="mt-4 pt-4 border-t">
                <p className="text-xs sm:text-sm font-bold text-foreground mb-3">
                  अन्य भुगतान विकल्प:
                </p>
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-1.5 sm:gap-2 bg-background rounded-lg p-2 sm:p-3 border hover:border-purple-500/50 transition-colors"
                    >
