          ...
          <CardContent className="relative z-10 p-6 sm:p-10 lg:p-16">
            <div className="text-center mb-10 sm:mb-12">
              ...
              <div className="flex justify-center">
                <Badge className="bg-gradient-to-r from-primary/20 to-secondary/20 text-foreground border-primary/30 px-5 py-2.5 text-sm font-semibold rounded-lg">
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-background to-muted/50 p-6 rounded-xl border border-border/50">
                <p className="text-base sm:text-lg leading-relaxed text-muted-foreground text-center lg:text-justify">
              ...
              <div className="bg-gradient-to-r from-primary/10 to-primary/5 border-l-4 border-primary p-6 rounded-r-xl">
                <p className="text-primary font-semibold text-base sm:text-lg leading-relaxed text-center lg:text-justify">
