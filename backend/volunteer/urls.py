...
from .views import WingListCreateView, WingDetailView, LevelListCreateView, LevelDetailView, DesignationListCreateView, DesignationDetailView, VolunteerListCreateView, VolunteerDetailView, ApplicationListCreateView, ApplicationDetailView, AssignVolunteerFromApplicationView, VolunteerWorkingAreaListCreateView
...
urlpatterns = [
    ...
    path('working-areas/', VolunteerWorkingAreaListCreateView.as_view(), name='volunteer-working-area-list-create'),
